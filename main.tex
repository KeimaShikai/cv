...
\linkedin{\underline{Danil Dudkin}}
\sectionsep
...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\textbf{Briefly about the project:} Development and distribution of telecom network security services
...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\textbf{Briefly about the projects:} Development, distribution and support of network security services
\begin{tightemize}

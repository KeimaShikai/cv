...
\begin{tightemize}
  \item Designed CI/CD using Gitlab CI and Bash to automate and accelerate the building code process of C++, Python, JS, as well as Docker images with their subsequent publication in Artifactory
